...
> **As-built submission document:** see [`../docs/solution-plan.md`](../docs/solution-plan.md) and [`../docs/architecture-diagrams.md`](../docs/architecture-diagrams.md).  
> The sections below are the earlier design draft; prefer the as-built docs for what the prototype actually implements.
